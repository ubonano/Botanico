...
import 'sign_in/sign_in_wrong_email_format_test.dart' as sign_in_wrong_email_format_test;
import 'sign_in/sign_in_wrong_password_lenght_test.dart' as sign_in_wrong_password_lenght_test;
...
import 'sign_up/sign_up_wrong_email_format_test.dart' as sign_up_wrong_email_format_test;
import 'sign_up/sign_up_wrong_password_lenght_test.dart' as sign_up_wrong_password_lenght_test;
import 'sign_up/sign_up_wrong_confirm_password_test.dart' as sign_up_wrong_confirm_password_test;
...
void _signUpTesting(String email, String password) {
  ...
  sign_up_wrong_email_format_test.main();
  sign_up_wrong_password_lenght_test.main();
  sign_up_wrong_confirm_password_test.main();
...
void _signInTesting(String email, String password) {
  ...
  sign_in_wrong_email_format_test.main();
  sign_in_wrong_password_lenght_test.main();
